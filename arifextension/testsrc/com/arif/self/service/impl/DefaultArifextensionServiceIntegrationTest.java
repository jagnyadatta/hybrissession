...
import com.arif.self.service.impl.DefaultArifextensionService;
 ...
 */
@IntegrationTest
public class DefaultArifextensionServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "arifextensionPlatformLogo";

		// when
		final String logoUrl = arifextensionService.getHybrisLogoUrl(logoCode);
