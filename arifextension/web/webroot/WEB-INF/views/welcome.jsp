...
<html>
<head>
    <title>Welcome to arifextension</title>
    <link rel="stylesheet" href="<c:url value="/static/arifextension-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "arifextension" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/arifextension-items.xml</b> - here you can model your items</li>
            <li><b>resources/arifextension-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/arifextension-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/arifextension-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/arifextension-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
