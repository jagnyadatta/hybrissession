...
public class DefaultArifextensionService implements ArifextensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultArifextensionService.class);
	...
	{
		return DefaultArifextensionService.class.getResourceAsStream("/arifextension/sap-hybris-platform.png");
	}
