...
/**
 * This is the extension manager of the Arifaddon extension.
 */
public class ArifaddonManager extends GeneratedArifaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ArifaddonManager.class.getName());
	 ...
	 */
	public static ArifaddonManager getInstance()
	{
		return (ArifaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ArifaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ArifaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ArifaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ArifaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ArifaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
